<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-2.5">
            <svg class="w-6 h-6 text-green-700 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <h2 class="font-black text-green-900 text-xl">Pengaturan Akun</h2>
        </div>
    </x-slot>
